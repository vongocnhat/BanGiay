				...
				<div class="col-lg-12">
					<div class="panel panel-default">
						...
						<div class="panel-body">
							<html:form action="quanly/productdetail/them" method="post" styleClass="form-horizontal">
								...
								<div class="form-actions">
									<html:submit value="Thêm" styleClass="btn btn-primary btn-large"></html:submit>
