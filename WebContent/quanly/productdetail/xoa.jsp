				...
				<div class="col-lg-12">
					<div class="panel panel-default">
						<div class="panel-heading">
							...
							<h5>Xóa Chi Tiết Sản Phẩm</h5>
						</div>
						<div class="panel-body">
							<html:form action="quanly/productdetail/xoa" method="post" styleClass="form-horizontal">
								...
								<div class="control-group">
									...
									<div class="controls">
										<html:text property="image" readonly="true" styleClass="form-control"></html:text>
									</div>
								</div>
								<div class="control-group">
									<label class="control-label required">Ảnh 2: </label>
									<div class="controls">
										<html:text property="image2" readonly="true" styleClass="form-control"></html:text>
									</div>
								</div>
								<div class="control-group">
									<label class="control-label required">Ảnh 3: </label>
									<div class="controls">
										<html:text property="image3" readonly="true" styleClass="form-control"></html:text>
									</div>
								</div>
								<div class="control-group">
									<label class="control-label required">Màu: </label>
									<div class="controls">
										<html:text property="color" styleClass="form-control" readonly="true" styleClass="form-control"/>
									</div>
								</div>

								<div class="form-actions">
									<html:submit value="Xóa" styleClass="btn btn-primary btn-large"></html:submit>
