					...
					<div class="panel-body">
						<html:form action="quanly/person/capnhat" method="post"
							...
							<div class="control-group">
								...
								<div class="controls">
									<input type="date" name="birthday" class="form-control no-spin"
							...
							<div class="control-group">
								...
								<div class="controls">
									<input type="text" name="phone" class="form-control"
										value='<bean:write name="personForm" property="phone"/>' id="phone" />
								</div>
							</div>
							<div class="control-group">
							...
							<div class="form-actions">
								<html:submit value="Lưu" styleClass="btn btn-primary btn-large btnSubmit"></html:submit>
...
$("input[type='checkbox']").attr("required", false);
	...
	var thongBao = '<bean:write name="personForm" property="thongBao" />';
if(thongBao == "Tài khoản đã tồn tại.")
{
	$("#userName").attr("readonly", false);
	$("#userName").val("");
	$('input[name="btnUpdate"]').val("add");
}
